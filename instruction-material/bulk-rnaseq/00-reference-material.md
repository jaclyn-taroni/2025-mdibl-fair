...
* [Harvard Chan Bioinformatics Core (HBC). _Introduction to bulk RNA-seq: From reads to count matrix_](https://hbctraining.github.io/Intro-to-bulk-RNAseq/schedule/links-to-lessons.html)
